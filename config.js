...
global.owner = process.env.OWNER_NUMBER || "237654765115";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "`ULTRON👾`",
  author: process.env.PACK_AUTHER || "`ULTRON👾`",
  packname: process.env.PACK_NAME || "`Stark👾`",
